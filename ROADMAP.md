...
**Current status: v0.16.0** — phases 5–13 shipped + a QA-fix batch (v0.14.0) + writing-aids & export-readiness (v0.15.0) + the Writing Mastery Academy feature set (v0.16.0). Next: the deep end-to-end live QA pass (the 1.0 gate) — v0.15.0 and v0.16.0 surfaces are unit/build-verified only.
